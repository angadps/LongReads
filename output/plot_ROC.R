...
filename <- paste0("ROC_",prev,"_",rlen,"_",cov,".pdf", collapse="")
ttl = paste0("prev=",prev,"%;rlen=",rlen,";cov=",cov, collapse="")
...
pdf(file=filename, colormodel="cmyk", width = 3, height = 3, pointsize=3)
#postscript(file=filename, colormodel="cmyk", width=3,height=2.25,horizontal=FALSE,pointsize=2)
#jpeg(file=filename)
xax = "#False positives"
yax = ""
...
legend(10,0.7,c("HapMut-1%","HapMut-2%","HapMut-4%","Mutect-1%","Mutect-2%","Mutect-4%"),cex=1.6,col=colors,pch=plotchar,lty=linetype)
